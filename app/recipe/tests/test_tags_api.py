...
class PublicTagsApiTets(TestCase):
    """docstring for PublicTagsApiTets."""
...
class PrivteTagsAiTests(TestCase):
    """test authorized user tagaapi."""
    def setUp(self):
    ...
    def test_tags_limited_to_user(self):
        """test that tags returnd are for authenticated user"""
        user2 =  get_user_model().objects.create_user(
            'other@gmail.com',
            'test132'
        )
        Tag.objects.create(user=user2,name='frutiy')
